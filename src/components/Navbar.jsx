...
function Navbar() {
   ...
   const linksCss = `flex  flex-col  lg:flex-row  max-lg:absolute lg:right-10 ${
    showMenu
    ...
    <div className=' ' >
     <nav className='mt-5 p-6  flex  flex-col justify-between lg:flex-row rounded-md z-20  mx-5'> 
      <div className='flex flex-row mb-4 md:mb-0 ml-8 lg:mr-16'>
        ...
        <div className='text-[#007E85] mt-2 tracking-wider mr-3 font-lato text-3xl font-bold'>Health</div>
        <div className='text-green-600  mt-2 tracking-wider font-lato text-3xl font-bold'>care</div>
      </div>
