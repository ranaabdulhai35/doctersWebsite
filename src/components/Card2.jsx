  ...
  return (
    <div className="grid grid-cols-1 justify-items-center mt-5 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {AllImpinfo2.map((info) => (
        <div key={info.id} className="max-w-sm bg-white border pt-4 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          {/* Profile Image */}
          <img
            className="w-32 h-32 rounded-full mx-auto"
            src={info.img}
          ...
          {/* Social Links */}
          <div className="flex mt-4 pb-4 justify-evenly">
