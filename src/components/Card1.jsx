...
function Card1({ data }) {
  return (
    <div className="max-w-sm  p-3 bg-white border border-gray-200 rounded-lg shadow items-center dark:bg-gray-800 dark:border-gray-700">
      <a className='flex justify-center' href="#">
        <img className="rounded-t-lg  " src={data.image} alt={data.name} />
      </a>
      <div className="p-5">
        <a href="#">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-[#007E85] dark:text-white">{data.name}</h5>
        </a>
        ...
        <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-[#007E85]  hfocus:ring-4 focus:outline-none  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
...
function CardGrid() {
  return (
    ...
    <div className="grid md:grid-cols-3 sm:grid-cols-2 justify-items-center gap-y-4">
      {AllImpinfo.map((item) => (
