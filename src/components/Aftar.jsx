...
function Aftar() {
  return (
    <div >
    <div className="flex space-x-2  mb-1 z-[12] fixed ml-16  p-3 w-40 items-center bg-white overflow-clip animate-out rounded-md zo h-[58px] duration-200 delay-300">
    <div>
