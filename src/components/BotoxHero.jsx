...
function BotoxHero() {
  return (
    <div>            <div className='w-[100%] flex items-center justify-evenly flex-row h-[528px] bg-[#016A70]  ' >
    ...
    <p className='w-[40ch] text-sm ' > BOTOX® Specialists are doctors 
        who are experienced in treating Chronic Migraine with BOTOX® to prevent headaches and migraine attacks
         ...
         <button className='bg-transparent text-white border-2 p-1 border-white  rounded-md ml-2 w-[210px] h-[51px]' >Learn More </button>
